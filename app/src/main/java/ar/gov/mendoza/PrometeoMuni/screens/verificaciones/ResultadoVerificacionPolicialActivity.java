...
public class ResultadoVerificacionPolicialActivity extends  AppCompatActivity { //ActionBarActivity {//FragmentActivity {//
	...
	public void handleIntent(Intent intent) {
		...
		Bundle appData = intent.getBundleExtra(ResultadoVerificacionPolicialActivity.APP_DATA);
		if (appData != null) 
		{
		    String datosLicencia = appData.getString(ResultadoVerificacionPolicialActivity.APP_DATA_LICENCIA,"");
		    String datosResultado=  appData.getString(ResultadoVerificacionPolicialActivity.APP_DATA_RESULTADO,"");
