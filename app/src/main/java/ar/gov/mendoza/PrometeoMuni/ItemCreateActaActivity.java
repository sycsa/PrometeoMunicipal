...
public class ItemCreateActaActivity  extends MendozaActivity //extends SherlockActivity
{// Activity 
...
//	          .show();
    ...
    public static final String CURRENT_ACTA_PAIS_DOCUMENTO_TITULAR = "PaisDocumentoTitular";	  
    public static final String CURRENT_ACTA_PROVINCIA_DOCUMENTO_TITULAR = "ProvinciaDocumentoTitular";
    public static final String CURRENT_ACTA_DEPARTAMENTO_DOCUMENTO_TITULAR = "DepartamentoDocumentoTitular";
    public static final String CURRENT_ACTA_LOCALIDAD_DOCUMENTO_TITULAR = "LocalidadDocumentoTitular";

    public static final String CURRENT_ACTA_PAIS_DOCUMENTO_TESTIGO = "PaisDocumentoTestigo";	  
    public static final String CURRENT_ACTA_PROVINCIA_DOCUMENTO_TESTIGO= "ProvinciaDocumentoTestigo";
    public static final String CURRENT_ACTA_DEPARTAMENTO_DOCUMENTO_TESTIGO= "DepartamentoDocumentoTestigo";
    public static final String CURRENT_ACTA_LOCALIDAD_DOCUMENTO_TESTIGO= "LocalidadDocumentoTestigo";
    public static final String CURRENT_ACTA_DEPARTAMENTO_INFRACCION = "DepartamentoInfraccion";
    public static final String CURRENT_ACTA_LOCALIDAD_INFRACCION = "LocalidadInfraccion";
    
    public static final String CURRENT_ACTA_TIPO_RUTA = "TipoRuta";
    public static final String CURRENT_ACTA_TIPO_VEHICULO = "TipoVehiculo";
    public static final String CURRENT_ACTA_UBICACION = "Ubicacion";
    public static final String CURRENT_ACTA_RUTA = "Ruta";
    public static final String CURRENT_ACTA_DESCRIPCION_UBICACION= "DescripcionUbicacion";
    public static final String CURRENT_ACTA_ENTIDAD= "Entidad";
    public static final String CURRENT_ACTA_SECCIONAL= "Seccional";
    
    public static final String CURRENT_ACTA_FECHA_VENCIMIENTO_LICENCIA = "FechaVencimientoLicencia";
    public static final String CURRENT_ACTA_FECHA_NACIMIENTO = "FechaNacimiento";
    
    public static final String CURRENT_ACTA_MARCA = "Marca";
    public static final String CURRENT_ACTA_MODELO_VEHICULO = "ModeloVehiculo";	  
    ...
    public static final String CURRENT_ACTA_INFRACCION3 = "Infraccion3";
    public static final String CURRENT_ACTA_INFRACCION4 = "Infraccion4";
    public static final String CURRENT_ACTA_INFRACCION5 = "Infraccion5";
    public static final String CURRENT_ACTA_INFRACCION6 = "Infraccion6";
    ...
    public static final String DEBUG_TAG = "DeviceActasActivityLog";
