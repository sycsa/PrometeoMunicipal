...
public class LocationService extends Service {
	...
	public static final String BROADCAST_ACTION = "ar.gov.mendoza.skeleton.action.GPS_UPDATE";
    ...
    {      
        ...
        locationManager.requestLocationUpdates(LocationManager.PASSIVE_PROVIDER, 4000, 0, listener);
    ...
    public class MyLocationListener implements LocationListener
    {
        ...
        public void onLocationChanged(final Location loc)
        {
           // Log.i("**************************************", "Location changed");
            if(LocationService.this.isBetterLocation(loc, previousBestLocation)) {
//                loc.getLatitude();
//                loc.getLongitude();             
