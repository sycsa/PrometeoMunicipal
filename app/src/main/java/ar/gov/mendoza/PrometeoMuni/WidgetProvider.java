		...
		private class WidgetUpdateTask extends
			...
			private boolean widgetUpdate(int startId) {
				...
				SharedPreferences prefs = getSharedPreferences(
						MendozaActivity.GAME_PREFERENCES, Context.MODE_PRIVATE);
				Integer playerId = prefs.getInt(
						MendozaActivity.GAME_PREFERENCES_PLAYER_ID, -1);
				...
				try {
					...
					// get the Android component name for the WidgetProvider
			...
			private WidgetData getWidgetData(int playerId) {
				...
				try {
					URL userInfo = new URL(MendozaActivity.TRIVIA_SERVER_BASE
			...
			public WidgetData getTopFriendWidgetData(int playerId) {
				...
				try {
					friendScoresUrl = new URL(MendozaActivity.TRIVIA_SERVER_SCORES
							+ "?playerId=" + playerId);
